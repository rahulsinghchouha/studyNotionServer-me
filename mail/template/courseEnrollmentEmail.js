exports.courseEnrollmentEmail = (courseName, name) => {
    ...
    <div class="body">
            <p>Dear ${name},</p>
            <p>You Seccesfully Registered for the Course <span class="highlight">"${courseName}"</span>
            are you exicted to have you as a participant!</p>
            <p>Please Login your learning dashboard to access the course material and start your learning journey</p>
